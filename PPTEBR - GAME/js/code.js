...
// Función para verificar si el juego finalizo - Devuelve booleano
function isGameFinished(healthA, healthB) {
     // Me devuelve todos estos valores a un booleano
     return ( 
          healthA > 0 && healthB == 0 ||
          healthA == 0 && healthB > 0 ||
          healthA == 0 && healthB == 0 ||
...
// Función random - Devuelve un número del "min" al "max" en entero
